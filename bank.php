...
<body>
            <div class="container-fluid aad">
                ...
                <p class="personal">My Bank</p>
            </div>
        <div class="container-fluid cot">
            <form id="registration-form" action="php/bank.php" method="post">
            <div class="row tty">
            <input type="text" id="username-input" placeholder="Full Name" name="name" required>
            ...
            <input type="text" id="username-input" placeholder="Mobile Number" name="mobile" oninput="this.value = this.value.replace(/[^0-9]/g, '')" maxlength="10" required>
                    ...
                    <div class="row tty">
            <input type="text" id="username-input" placeholder="Bank Name" name="bank" required>
        </div>
                    <div class="row tty">
            <input type="text" id="bank-input" placeholder="Bank Number" name="bank_number" oninput="this.value = this.value.replace(/[^0-9]/g, '')" maxlength="14" required>
            <span id="bankNumberError" style="color: red; display: none;">Bank number should be 14 digits</span>
        </div>
                    <div class="row tty">
            <input type="text" id="amountInput" placeholder="IFSC Code" name="ifsc" maxlength="11" required >
        </div>
                    <div class="row tty">
            <input type="password" id="password-input" name="bank_password" placeholder="Withdrawl Password" required>
