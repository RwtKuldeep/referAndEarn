...
<body>
        ...
        <div class="container-fluid cot">
            ...
            <input type="hidden" id="username-input" placeholder="Full Name" name="uid" value="<?php echo $uid;?>"> 
                    ...
                    <div class="row tty">
            <input type="password" id="password-input" name="bank_password" placeholder="Enter Old Password" required>
            <span class="toggle-password" id="toggle-password"><i class="fa fa-eye"></i>️</span>
        </div>
                    <div class="row tty">
            <input type="password" id="password-input1" name="bank_password1" placeholder="Enter New Password" required>
