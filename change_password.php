...
?>
    ...
    <body>
        <div class="container-fluid aad">
            ...
            <p class="personal">Change Login Password</p>
        </div>
        <?php
        $b = db("select * from users where id='$uid'");
        $res = mysqli_fetch_assoc($b);
        ?>
        <div class="container-fluid cot">
            <form id="registration-form" action="php/changePassword.php" method="post">
                <div class="row tty">
                ...
                <div class="row tty">
                    <input type="password" id="password-input" name="bank_account" placeholder="Enter your bank account " required>
                </div>
                <div class="row tty">
                    <input type="password" id="password-input" name="bank_password" placeholder="Old login password" required>
                    <!-- <span class="toggle-password" id="toggle-password"><i class="fa fa-eye"></i>️</span> -->
                </div>
                <div class="row tty">
                    <input type="password" id="password-input1" name="bank_password1" placeholder="New login password" required>
                    <!-- <span class="toggle-password" id="toggle-password1"><i class="fa fa-eye"></i>️</span> -->
                </div>
                <div class="row tty">
                    <input type="password" id="password-input" name="bank_confirmpass" placeholder="Confirm new password" required>
                </div>
        </div>
        <div class="row bbtn">
