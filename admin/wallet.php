    ...
    <?php include 'pack/SideNav.php'; ?>
        ...
        <div class="container-fluid family">
            ...
            <div class="row">
                <div class="col-md-12 ">
                    <div class="row  mt-5">
                      <div class="col-8"><h3 class="family"><b>All Wallets</b></h3></div>
  ...
  function PaymentAmountFun(id)
  {
    ...
    <script>
      ...
      window.operateEvents = 
      {
            ...
            {
                let id = JSON.stringify(parseInt(row.id));
                delete_confirm("php/wallet/delete.php?id="+id);
            }
}
    ...
    //   ModelOpenCreditAdd End ------------------------------------------------
      ...
      function initTable() 
      {
        ...
        $remove.click(function () {
          ...
          delete_confirm("php/wallet/delete.php?id="+ids);
        })
      }
