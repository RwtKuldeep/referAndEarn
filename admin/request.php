    ...
    <?php include 'pack/SideNav.php'; ?>
        ...
        <div class="container-fluid family">
            ...
            <div class="row">
                <div class="col-md-12 ">
                    <div class="row  mt-5">
                      <div class="col-8"><h3 class="family"><b>All Requests</b></h3></div>
    ...
    <script>
      ...
      window.operateEvents = 
      {
            ...
            'click .remove': function (e, value, row, index) 
            {
                ...
                delete_confirm("php/contactDelete.php?id="+id);
            }
    }
    ...
    //   ModelOpenCreditAdd End ------------------------------------------------
      ...
      function initTable() 
      {
        ...
        $remove.click(function () {
          ...
          delete_confirm("php/contactDelete.php?id="+ids);
        })
      }
