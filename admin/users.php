...
if ($Admin) {
  ...
  if (isset($_GET['type'])) {
    ...
    if ($type == 'status') {
      ...
      $update_status_sql = db("update users set status = '$status' where id='$id'");
    }
  }
?>
  <!DOCTYPE html>
      ...
      <div class="container-fluid family">
        ...
        <div class="row">
          <div class="col-md-12 ">
            <div class="row  mt-5">
              <div class="col-8">
                <h3 class="family"><b>All Users</b></h3>
              </div>
  ...
  <script>
    ...
    window.operateEvents = {
      ...
      'click .remove': function(e, value, row, index) {
        let id = JSON.stringify(parseInt(row.id));
        delete_confirm("php/user/delete.php?id=" + id);
      }
    }
    ...
    function initTable() {
      $table.bootstrapTable('destroy').bootstrapTable({
        ...
        columns: [{
          ...
          },
          {
            ...
            align: 'center',
            clickToSelect: false,
            events: window.operateEventsViewStatus,
      ...
      $table.on('check.bs.table uncheck.bs.table ' + 'check-all.bs.table uncheck-all.bs.table', function() {
        ...
        $bookmarkBtn.prop('disabled', !$table.bootstrapTable('getSelections').length)
      ...
      $remove.click(function() {
        ...
        delete_confirm("php/user/delete.php?id=" + ids);
      });
      $bookmarkBtn.click(function() {
        var ids = getIdSelections()
        window.location.href = "php/user/add_bookmark.php?id=" + ids;
      });
    }
