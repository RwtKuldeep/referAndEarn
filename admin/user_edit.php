                ...
                <div class="table-responsive">
                  ...
                  ?>
                    ...
                    <div class="modal-dialog modal-xl" role="document">
                      <form method="post" action="php/user/edit.php" autocomplete="off">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h3 class="modal-title family font-weight-bold" id="exampleModalLongTitle">Edit Category</h3>
                            <a href="users.php"><button type="button" class="close text-danger" aria-label="Close"> <span style="font-size: 32px;" aria-hidden="true">&times;</span> </button></a>
                          </div>
                            ...
                            <div class="row w-100 mt-4">
                              <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control family" name="name" placeholder="Enter Category Name" value="<?php echo $row['name']; ?>" required>
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label class="family">User Mobile*</label>
                                  <input type="text" class="form-control family" name="mobile" placeholder="Enter Category Name" value="<?php echo $row['mobile']; ?>" required>
                                </div>
                              </div>
                            </div>
                            <!--name-->
                            <div class="row w-100 mt-4">
                              <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control family" name="password" placeholder="Enter Category Name" value="<?php echo $row['password']; ?>" required>
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label class="family">Promo*</label>
                                  <input type="text" class="form-control family" name="promo" placeholder="Enter Category Name" value="<?php echo $row['promo']; ?>" required>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="modal-footer">
                            <a href="users.php"><button type="button" class="btn btn-light" data-dismiss="modal">Close</button></a>
