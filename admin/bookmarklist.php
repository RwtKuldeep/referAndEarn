            ...
            <div class="container-fluid family">
                ...
                <div class="row">
                    <div class="col-md-12 ">
                        <div class="row  mt-5">
                            <div class="col-8">
                                <h3 class="family"><b>Favourite Users</b></h3>
                            </div>
    ...
    <script>
        ...
        window.operateEvents = {
            ...
            'click .remove': function(e, value, row, index) {
                let id = JSON.stringify(parseInt(row.id));
                delete_confirm("php/user/del_bookmark.php?id=" + id);
            }
        }
        ...
        function initTable() {
            ...
            $remove.click(function() {
                ...
                delete_confirm("php/user/del_bookmark.php?id=" + ids);
            });
        }
